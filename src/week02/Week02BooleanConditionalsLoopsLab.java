...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		age = sc.nextInt(); 
		if(age<18) {
		System.out.print("El usuario es mayor de 18: ");
		System.out.println(age>=18);}
		}while(age<18);
		System.out.print("El usuario es mayor de 18: ");
		System.out.println(age>=18);
        */
		...
		if(age>=16 && !hasLicense) {
			...
			System.out.println("You can drive, Congratulations!!!");
		...
		int MyReward;
		MyReward=numberOfCookies-numberOfChildren;
		...
		case "SILVER": System.out.println("Your Loyalty Member Discount is: " + (loyaltyMemberDiscount+=0.10) );
			
			break;
		case "GOLD":  System.out.println("Your Loyalty Member Discount is: " + (loyaltyMemberDiscount+=0.15) );
			
			break;
		case "PLATINUM":  System.out.println("Your Loyalty Member Discount is: " + (loyaltyMemberDiscount+=0.25) );
			
			break;

		default:
			System.out.println("Your Loyalty Member Status is wrong");
			break;
		}
		...
		if(loyaltyMemberStatus=="SYLVER" && adjustedTotal>500) {
			loyaltyMemberStatus="GOLD";
			System.out.println("The amount to pay is: " + adjustedTotal);
			System.out.println("Your New Loyalty Member Status is: " + loyaltyMemberStatus);
			
		}else if ((loyaltyMemberStatus=="GOLD") && (adjustedTotal>500) ) {
			loyaltyMemberStatus="PLATINUM";
			System.out.println("The amount to pay is: " + adjustedTotal);
			System.out.println("Your New Loyalty Member Status is: " + loyaltyMemberStatus);
			
		}else System.out.println("The amount to pay is: " + adjustedTotal);
		System.out.println("\n");
		...
		int o=100;
		while(o>=0) {
			//System.out.println("Dividir " + o +" entre 3 es igal a " + (o/3) + "");
